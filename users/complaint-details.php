...
echo "Not Process yet";
            ...
            <?php
echo '<form class="form-inline" method="post" action="generate-user-pdf.php">';
echo '<button type="submit" id="pdf" name="generate-user-pdf" class="btn btn-primary"><i class="fa fa-pdf" "="" aria-hidden="true"></i>';
